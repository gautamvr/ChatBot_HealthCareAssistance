...
namespace EmployeeService
{
    ...
    {
        [OperationContract]
        [WebInvoke(Method ="GET",UriTemplate ="/EmpSalaryDetail",RequestFormat =WebMessageFormat.Json,ResponseFormat =WebMessageFormat.Json,BodyStyle =WebMessageBodyStyle.Wrapped)]
